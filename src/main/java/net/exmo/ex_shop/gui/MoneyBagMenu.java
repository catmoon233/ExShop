...
public class MoneyBagMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public MoneyBagMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(ESMenus.MONEY_BAG_MENU.get(), id);
...
//        }));
        ...
        for (int i =0 ; i < slotCount; i++){
            int finalI = i;
            this.addSlot(new SlotItemHandler(internal, finalI, start_x, start_y) {
                @Override
